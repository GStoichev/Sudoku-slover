...
int main()
{
	...
	Sudoku empty;
	empty.SetValue(0, 0, 0, 0, 4);
	empty.SetValue(0, 0, 2, 2, 9);
	empty.SetValue(2, 0, 2, 0, 2);
	empty.SetValue(1, 0, 0, 0, 7);
	empty.SetValue(0, 0, 0, 1, 2);
	empty.SetValue(1, 1, 1, 1, 7);
	empty.SetValue(2, 1, 2, 1, 4);
	empty.SetValue(2, 1, 0, 1, 8);
	empty.SetValue(0, 2, 2, 2, 3);
	empty.SetValue(1, 2, 1, 1, 4);
	empty.SetValue(0, 2, 0, 2, 9);
	empty.SetValue(2, 2, 0, 0, 3);
	empty.SetValue(2, 2, 2, 2, 1);
	empty.SetValue(2, 1, 1, 1, 1);
	empty.SetValue(1, 1, 1, 2, 8);
	empty.SetValue(0, 0, 0, 2, 5);
	empty.SetValue(0, 1, 0, 2, 6);
	empty.Print();
	std::cout << std::endl;
